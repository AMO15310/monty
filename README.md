...
Entering queue mode to perform all operations in FIFO (queue) mode instad of default LIFO (stack) mode. Note: does not change current stack, sets front of queue to top of stack.
